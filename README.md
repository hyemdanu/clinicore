[![Front End Tools: ](https://github.com/cable8mm/water-melon/actions/workflows/code-style.yml/badge.svg)]((https://maven.apache.org/)
...
npm run dev
```
You may need to install NPM via 
```ssh
npm install 
```
